...
namespace ContactRepository
{
    ...
    public class ContactRepository//Maps to Database table Contact                                                                                                                                                      
    {
        public ContactModel Add(ContactModel contactModel)
        {
            var contactDb = ToDbModel(contactModel);//convert to database Model

            DatabaseManager.Instance.Contact.Add(contactDb);//Adds contact db record to database
